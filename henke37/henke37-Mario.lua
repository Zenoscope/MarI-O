-- MarI/O by SethBling and Henke37
...
BasePath= "C:\\Users\\Henrik\\Desktop\\"
Filename = "YI1.state"
ButtonNames = {
        "A",
        "B",
...
BoxRadius = 6
TileMapInputSize = (BoxRadius*2+1)*(BoxRadius*2+1)
TotalInputSize=TileMapInputSize + 6
 
Inputs = TotalInputSize+1
Outputs = #ButtonNames
...
function getSprites()
        ...
        for slot=0,11 do
                ...
                if status ~= 0 then
                        ...
                        sprites[#sprites+1] = {["x"]=spritex, ["y"]=spritey, ["status"]=status}
                end
        end            
...
function getExtendedSprites()
        ...
        for slot=0,11 do
                ...
                if number ~= 0 then
                        ...
                        extended[#extended+1] = {["x"]=spritex, ["y"]=spritey,["number"]=number}
                end
        end            
...
function getInputs()
        ...
        for dy=-BoxRadius*16,BoxRadius*16,16 do
                for dx=-BoxRadius*16,BoxRadius*16,16 do
                        ...
                        for i = 1,#sprites do
                                ...
                                if distx <= 8 and disty <= 8 and sprites[i]["status"] then
                                        inputs[#inputs] = -sprites[i]["status"]
                                end
                        end
                        ...
                        for i = 1,#extended do
                                ...
                                if distx < 8 and disty < 8 and extended[i]["number"] then
                                        inputs[#inputs] = -extended[i]["number"]
                                end
                        end
                end
        end
        ...
        pmeter= memory.read_u8(0x13E4)
        takeoffmeter= memory.read_u8(0x149F)
        powerup=memory.read_u8(0x19)
        balloontimer=memory.read_u8(0x1891)
       
        inputs[TileMapInputSize+1] = mariovx
        inputs[TileMapInputSize+2] = mariovy
        inputs[TileMapInputSize+3] = pmeter
        inputs[TileMapInputSize+4] = takeoffmeter
        inputs[TileMapInputSize+5] = powerup
        inputs[TileMapInputSize+6] = balloontimer
