-- MarI/O by SethBling and F9Alejandro
-- Feel free to use this code, but please do not redistribute it.
-- Intended for use with the BizHawk emulator and Super Mario World or Super Mario Bros. ROM.

-- Death/Restart data show only
...
writeFile("temp1.pool")
 
event.onexit(onExit)
event.onloadstate(restartCount)
...
while true do
        ...
        if not forms.ischecked(hideBanner) then
                gui.drawBox(0, 0, 300, 30, backgroundColor, backgroundColor)
        end
